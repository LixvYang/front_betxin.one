...
<template>
    <div id="topic-info">
        ...
        >
            <div
                class="p-3 items-center bg-gray-50 rounded-lg shadow sm:flex dark:bg-gray-900 dark:border-gray-700"
            >
                <a href="#">
                    <img
                        class="w-20 h-20 rounded-full"
                        :src="userStore.getUserInfo.avatar_url"
                        alt="Rounded avatar"
                    />
                </a>
                <div class="p-5">
                    ...
                    >
                        <a href="#">{{ userStore.getUserInfo.full_name }}</a>
                    </p>
                    <p
                        class="mt-3 mb-4 font-light text-gray-500 dark:text-gray-400"
                    >
                        {{ userStore.getUserInfo.biography }}
                    </p>
