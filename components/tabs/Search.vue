        ...
        <form class="md:hidden relative">
            <div class="flex">
                ...
                <button id="dropdown-button" data-dropdown-toggle="dropdown"
                    class="flex-shrink-0 z-10 inline-flex items-center py-2.5 px-2 text-sm  text-center text-gray-900 bg-gray-100 border border-gray-300 rounded-s-lg hover:bg-gray-200 focus:ring-4 focus:outline-none focus:ring-gray-100 dark:bg-gray-700 dark:hover:bg-gray-600 dark:focus:ring-gray-700 dark:text-white dark:border-gray-600"
                ...
                <div id="dropdown"
                    class="z-10 hidden bg-gray-100 divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-900">
                ...
                <div class="relative w-full">
                    <input type="search" id="search-dropdown"
                        ...
                        placeholder="Search Mockups..." required>
                    <button type="submit"
