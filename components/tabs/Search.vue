    ...
    <div id="tabs-search">
        <div class="flex w-full">
            <button
                ...
                data-dropdown-toggle="category-dropdown-menu"
            ...
            >
                ...
                <svg
                    class="relative right-1 w-2.5 h-2.5 ms-2.5"
                    aria-hidden="true"
            ...
            >
                <ul
                    class="py-2 text-sm text-gray-700 dark:text-gray-200 divide-y divide-double"
