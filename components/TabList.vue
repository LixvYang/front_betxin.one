...
onMounted(() => {
 ...
 <!-- id="tab-list" class=""  -->
<template>
    <div id="tab-list" class="max-w-md divide-y divide-gray-200 dark:divide-gray-700">
        <div class="flex flex-row overflow-x-auto  whitespace-nowrap mb-4 border-b  border-gray-200 dark:border-gray-700">
