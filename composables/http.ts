...
//全局基础URL
const BASEURL: string = "http://localhost:9091"  //全局后台服务器请求地址
 ...
 * @returns 响应结果
 */
export const http = <T = any>(obj: HttpParms): Promise<BetxinResp<T>> => {
    const res = new Promise<BetxinResp<T>>((resolve, reject) => {
        useFetch(
