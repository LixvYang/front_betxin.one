...
<template>
        ...
        <nav class="bg-white border-gray-200 px-4 lg:px-6 py-2.5 dark:bg-gray-700">
            <div class="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
                <a href="https://flowbite.com" class="flex items-center">
                    ...
                    <span class="self-center text-xl font-semibold whitespace-nowrap dark:text-white">Betxin</span>
                </a>
                ...
                <div id="dropdownTop"
                    ...
                    <ul class="py-2 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="dropdownRightButton">
                        ...
                        <li>
                            ...
                            <span id="theme-toggle-dark-icon" class="hidden w-5 h-5" fill="currentColor">深色模式</span>
                            <span id="theme-toggle-light-icon" class="hidden w-5 h-5" fill="currentColor">浅色模式</span>
                            </button>
                        </li>
                        <li>
                            <a href="#"
    ...
    <footer class="hidden md:block bg-white dark:bg-gray-900 fixed bottom-0 left-0 right-0 mx-auto w-full p-4 py-6">
